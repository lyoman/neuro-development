...
export class ChooseCorrectPage implements OnInit {
  ...
  ngOnInit() {
    ...
    this.originalFootSteps = this.graphicsService.anime;//original order of anime
    // console.log('original footsteps', this.originalFootSteps);

    console.log(localStorage.getItem("animelogic"));
  ...
  rebuildOriginal() {
    this.getUserNum = JSON.parse(localStorage.getItem('animeinitialNum'));
  ...
  results (footsteps) {
    ...
    // this.router.navigateByUrl('/sequential/anime/results');
  }
